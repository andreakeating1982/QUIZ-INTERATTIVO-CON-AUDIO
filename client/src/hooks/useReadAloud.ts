 ...
 *
 * QUIZ INTERATTIVO: le OPZIONI DI RISPOSTA sono `<button>` con il testo della
 * risposta, quindi NON escludiamo i pulsanti (altrimenti non verrebbero lette
 * le risposte!). Escludiamo solo toolbar, canvas, svg e script.
 *
 * Accorgimenti:
