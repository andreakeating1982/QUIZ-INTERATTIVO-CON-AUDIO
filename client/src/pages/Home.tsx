...
export default function Home() {
  ...
  /* Margini pareggiati della prima pagina (come nell'app sorgente
     PAROLE-CHIAVE-INTERATTIVE): vista autonoma (fuori dall'iframe del blog) —
     la pagina deve "terminare" subito sotto la card, senza il grande vuoto
     crema sotto il contenuto. La classe `lf-welcome-top` su <html> rende
     neutro (bianco) il canvas sotto il contenuto e aggiunge una dissolvenza
     morbida in fondo al blocco crema. Dentro la cornice (iframe) NON viene
     aggiunta: lì è heightSync a segnalare l'altezza reale del contenuto e la
     cornice dinamica si restringe da sola (regole html.lf-embedded .lf-welcome
     in index.css: 24px sopra e sotto). */
  useEffect(() => {
