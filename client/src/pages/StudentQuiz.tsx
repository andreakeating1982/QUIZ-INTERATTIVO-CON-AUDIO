...
export default function StudentQuiz() {
  ...
  // Reading pause active — show reading screen instead of question
  if ((currentClass?.readingPauseStage ?? 0) > 0 && sessionStarted) {
    return (
      <div className="min-h-screen bg-background paper-grain flex flex-col">
        <header className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-9">
          <div className="text-center">
        ...
        <main className="flex-1 flex items-start justify-center px-4 pb-16">
          <Card className="bg-card border border-border/60 shadow-sm max-w-2xl w-full animate-pop-in">
            <CardContent className="p-8 sm:p-12 flex flex-col items-center gap-6">
              <div className="size-20 rounded-2xl bg-amber-100 flex items-center justify-center">
                <BookOpen className="size-10 text-amber-600" />
              </div>
              <h2 className="text-xl sm:text-2xl font-bold text-amber-900 text-center">PAUSA DI LETTURA</h2>
              ...
              <div className="flex items-center gap-3 rounded-xl bg-amber-50 border border-amber-200 px-5 py-3">
                ...
                <span className="text-sm text-amber-700 font-medium">
                  In attesa che il docente prosegua
                </span>
              </div>
              <div className="w-full p-4 rounded-2xl bg-muted/50 border border-border/50 flex items-center justify-center gap-3">
                <BookOpen className="size-5 text-plum/60" />
